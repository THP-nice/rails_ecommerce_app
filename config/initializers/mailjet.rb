...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials.dig(:mailjet, :api_key_mailjet)
  config.secret_key = Rails.application.credentials.dig(:mailjet, :secret_key_mailjet)
  config.default_from = 'THP.niceteam@gmail.com'
